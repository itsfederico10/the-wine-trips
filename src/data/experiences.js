...
export const experiences = [
  {
    ...
    description: 'Seis días entre Premiers Crus clasificados, de la grava legendaria del Médoc a la piedra caliza de Saint-Émilion. Visitas guiadas con cata en châteaux históricos, la Cité du Vin, un walking tour por Bordeaux y la gran mesa del Sudoeste francés, con base en un 5★ de diseño.',
    highlights: [
      'Visitas guiadas con cata en châteaux clasificados',
      'Château Haut-Brion, Premier Cru Classé de 1855',
      'Saint-Émilion, pueblo Patrimonio de la Humanidad',
      'Cena en Passage Secret Bordeaux (en la guía Michelin)',
    ],
    duration: '6 DAYS',
    groupSize: '8 Guests',
    season: 'May / Sept–Oct',
    ...
    tripHighlights: [
      ...
      { icon: 'compass', text: 'Walking tour guiado por Bordeaux: Place de la Bourse y casco UNESCO' },
    ...
    itinerary: [
      {
        ...
        image: '/images/bordeaux/dia1.webp',
      ...
      },
      {
        ...
        image: '/images/bordeaux/dia4.webp', imgPos: 'center 66%',
        meals: 'Pensión completa', lodging: 'Mondrian Bordeaux',
      ...
      },
      {
        ...
        body: 'Cruzamos a la Rive Droite, tierra del Merlot. Paseo guiado por Saint-Émilion (Patrimonio de la Humanidad): calles medievales, la iglesia monolítica tallada en la roca y el claustro. Visita guiada y cata en Château Figeac (Premier Grand Cru Classé A); almuerzo en L\'Envers du Décor, junto a la iglesia. Por la tarde, Château La Gaffelière (Premier Grand Cru Classé B). Cena de despedida en Passage Secret Bordeaux, mencionado en la guía Michelin (sin estrella).',
    ...
    includes: [
      ...
      '6 visitas guiadas con cata en châteaux clasificados (Léoville-Poyferré, Pichon Baron, Haut-Brion, Smith Haut Lafitte, Figeac, La Gaffelière)',
      'Walking tour guiado por Bordeaux y paseo guiado por Saint-Émilion',
      'Entradas a La Cité du Vin con copa en el Belvédère',
      'Almuerzos y cenas indicados en el itinerario',
    ],
    excludes: [
  ...
  },
  {
    ...
    brochure: '/brochures/piemonte.pdf',
    tripHighlights: [
