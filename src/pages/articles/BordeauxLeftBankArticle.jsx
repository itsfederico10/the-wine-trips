          ...
          <div className="absolute inset-0 flex items-center justify-center text-center px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-['Cormorant_Garamond'] text-white leading-tight font-light mb-6">
                Bordeaux's Left Bank:<br />A Masterclass in Terroir
              </h1>
            </motion.div>
          </div>
        </header>
        ...
        <article className="max-w-[780px] mx-auto px-6 -mt-20 relative z-10">
          ...
          >
            <p className="text-xl font-['Cormorant_Garamond'] italic text-gray-600 mb-8 border-l-2 border-[#c9a96e] pl-6 py-2">
              "To understand the Left Bank is to understand the profound conversation between the Atlantic ocean, the gravel soils, and the noble Cabernet Sauvignon grape."
            </p>
            ...
            <h2 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mt-12 mb-6">The Importance of Gravel</h2>
            <p className="mb-6">
              If there is one word that defines the terroir of the Left Bank, it is <em>gravel</em>. Millions of years ago, the rivers carried smooth, heat-retaining stones from the Pyrenees mountains and deposited them here. These gravel soils serve two critical functions:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-8 marker:text-[#c9a96e]">
              <li><strong>Drainage:</strong> The stones allow water to drain away quickly, forcing the vines' roots to dig deep—sometimes 10 meters or more—into the subsoil to find moisture and nutrients. This struggle creates intensity and complexity in the fruit.</li>
              <li><strong>Heat Retention:</strong> The pale stones reflect sunlight back onto the vines and retain heat during the night, aiding the ripening of the late-ripening Cabernet Sauvignon grape.</li>
            </ul>

            <h2 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mt-12 mb-6">The Kingdom of Cabernet</h2>
            <p className="mb-6">
              While almost all red Bordeaux is a blend, the Left Bank is the undisputed kingdom of Cabernet Sauvignon. Here, the blend is typically dominated by Cabernet (often 60–80%), supported by Merlot, Cabernet Franc, and Petit Verdot.
            </p>
            <p className="mb-6">
              The resulting wines are structured, tannic, and built for the long haul. A young Pauillac or St-Estèphe can be austere, even forbidding. But give it 15, 20, or 40 years, and it transforms into a beverage of profound elegance, offering notes of cedar, pencil shavings, blackcurrant (cassis), and cigar box.
            </p>

            <h2 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mt-12 mb-6">Navigating the Appellations</h2>
            <p className="mb-6">
              Driving north from the city of Bordeaux along the D2 highway (the "Route des Châteaux"), you pass through the four legendary communes of the Haut-Médoc:
            </p>

            <h3 className="text-xl font-['Cormorant_Garamond'] text-[#c9a96e] uppercase tracking-widest mt-8 mb-4">Margaux</h3>
            <p className="mb-4">
              The most southerly and extensive of the four. Margaux wines are famed for their perfume, elegance, and silkiness. They are often described as the "iron fist in a velvet glove."
            </p>

            <h3 className="text-xl font-['Cormorant_Garamond'] text-[#c9a96e] uppercase tracking-widest mt-8 mb-4">Saint-Julien</h3>
            <p className="mb-4">
              The smallest commune, but arguably the most consistent. Saint-Julien offers the perfect balance between the elegance of Margaux and the power of Pauillac. It has no First Growths, but an abundance of "Super Seconds."
            </p>

            <h3 className="text-xl font-['Cormorant_Garamond'] text-[#c9a96e] uppercase tracking-widest mt-8 mb-4">Pauillac</h3>
            <p className="mb-4">
              The seat of power. Home to three of the five First Growths (Lafite, Latour, Mouton), Pauillac produces the quintessential Left Bank wine: dark, dense, powerful, and incredibly long-lived.
            </p>

            <h3 className="text-xl font-['Cormorant_Garamond'] text-[#c9a96e] uppercase tracking-widest mt-8 mb-4">Saint-Estèphe</h3>
            <p className="mb-8">
              The northernmost commune, where the soil contains more clay. This helps the vines in hot, dry years. Historically known for rustic tannins, modern winemaking has revealed a unique spicy, earthy character here that is winning global acclaim.
            </p>

            <p className="mt-12 text-lg font-medium italic text-gray-800">
              Visiting these estates is not merely a tasting opportunity; it is a step into living history, where the classifications of 1855 still dictate the hierarchy of one of the world's most lucrative luxury markets.
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap gap-3 mb-16 justify-center">
            {['Bordeaux', 'Left Bank', 'Médoc', 'Cabernet Sauvignon', 'Château Visits', 'Wine Travel', 'France'].map((tag) => (
