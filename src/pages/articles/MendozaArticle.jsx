          ...
          <div className="absolute inset-0 flex items-center justify-center text-center px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-['Cormorant_Garamond'] text-white leading-tight font-light mb-6">
                Mendoza's Hidden Gems:<br />Beyond the Malbec
              </h1>
            </motion.div>
          </div>
        </header>
        ...
        <article className="max-w-[780px] mx-auto px-6 -mt-20 relative z-10">
          ...
          >
            <p className="text-xl font-['Cormorant_Garamond'] italic text-gray-600 mb-8 border-l-2 border-[#c9a96e] pl-6 py-2">
              "Mendoza is not a monolith. It is a vertical landscape where every 100 meters of elevation rewrites the rules of what is possible in the glass."
            </p>

            <p className="mb-6">
              To the average consumer, Mendoza is synonymous with Malbec. It is a relationship that has served Argentina well, putting the country firmly on the global wine map with fruit-forward, velvety reds that offer immense pleasure. However, focusing solely on Malbec is like visiting Paris and never leaving the Eiffel Tower; you miss the true soul of the place.
            </p>

            <p className="mb-6">
              A quiet revolution is taking place in the foothills of the Andes. Winemakers, having mastered their flagship varietal, are now pushing the boundaries of terroir with world-class Cabernet Franc, laser-sharp Chardonnay, and Pinot Noir that rivals the Old World.
            </p>

            <h2 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mt-12 mb-6">The Vertical Factor</h2>
            <p className="mb-6">
              In most wine regions, latitude (distance from the equator) determines climate. In Mendoza, <em>altitude</em> is king. The difference between a vineyard at 900 meters in Luján de Cuyo and one at 1,500 meters in Gualtallary is profound.
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-8 marker:text-[#c9a96e]">
              <li><strong>Thermal Amplitude:</strong> High-altitude sites experience massive temperature swings—warm days and freezing nights. This preserves acidity while allowing sugar accumulation.</li>
              <li><strong>UV Radiation:</strong> The thin mountain air allows for intense UV exposure, causing grape skins to thicken as a protective measure. This results in wines with deep color and powerful antioxidants.</li>
            </ul>

            <h2 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mt-12 mb-6">The Rise of Cabernet Franc</h2>
            <p className="mb-6">
              If Malbec is the king of Mendoza, Cabernet Franc is the rising prince. Originally planted as a blending grape, it has found a unique expression in the limestone-rich soils of the Uco Valley.
            </p>
            <p className="mb-6">
              Unlike the herbaceous examples from the Loire Valley, high-altitude Argentine Franc is floral, mineral, and spicy, often showing notes of roasted red pepper, graphite, and wild herbs. Producers like El Enemigo and Catena Zapata have proven that these wines can achieve 100-point scores and stand toe-to-toe with the best of Bordeaux.
            </p>

            <h2 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mt-12 mb-6">White Wines of the Desert</h2>
            <p className="mb-6">
              Perhaps the most surprising discovery for visitors is the quality of Mendoza's white wines. Historically, the region was considered too hot for elegant whites. The solution? Go higher.
            </p>
            <p className="mb-6">
              In the extreme altitudes of Tupungato and Gualtallary, Chardonnay retains a razor-sharp acidity and saline minerality that is reminiscent of Chablis, yet with a distinct South American sun-kissed fruit profile.
            </p>

            <h3 className="text-xl font-['Cormorant_Garamond'] text-[#c9a96e] uppercase tracking-widest mt-8 mb-4">Luján de Cuyo vs. Uco Valley</h3>
            <p className="mb-4">
              Understanding Mendoza requires distinguishing between its two main zones:
            </p>
            <p className="mb-4">
              <strong>Luján de Cuyo:</strong> The traditional heartland. Lower altitude, warmer, with old vines (some over 100 years old). The wines here are lush, soft, and generous.
            </p>
            <p className="mb-8">
              <strong>Uco Valley:</strong> The wild frontier. Higher, cooler, and rockier. The wines are tense, structured, floral, and built for long aging. It is here that the "new Argentina" is being defined.
            </p>

            <p className="mt-12 text-lg font-medium italic text-gray-800">
              To visit Mendoza today is to witness a region in transition—confident in its heritage, yet relentlessly exploring new frontiers. It is a place where the mountains don't just provide a backdrop; they dictate the very essence of the liquid in your glass.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-3xl font-['Cormorant_Garamond'] text-[#1a1f2e] mb-4">Explore our Mendoza Experience</h3>
            <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
              Seven days through Luján de Cuyo, Maipú, and the high-altitude Uco Valley. Private bodega access, harvest season visits, and the full breadth of Argentine wine. Limited to 4–8 guests.
            </p>
          ...
          <div className="flex flex-wrap gap-3 mb-16 justify-center">
            {['Mendoza', 'Argentina', 'Malbec', 'Uco Valley', 'High Altitude Wine', 'South American Wine', 'Wine Travel', 'Bodega Visits'].map((tag) => (
